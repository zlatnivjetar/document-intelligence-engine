...
Plans:
- [ ] 03-01-PLAN.md — Receipt template (TMPL-02) and W-2 template (TMPL-03) with unit tests, wired into barrel
...
| 2. Extraction Pipeline + Invoice Template | 3/4 | In Progress | - |
