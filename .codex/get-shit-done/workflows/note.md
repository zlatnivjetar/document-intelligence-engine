...
- **Global scope**: `C:/Users/david/Desktop/github/document-intelligence-engine/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/david/Desktop/github/document-intelligence-engine/.codex/notes/`)
...
2. Glob `C:/Users/david/Desktop/github/document-intelligence-engine/.codex/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/david/Desktop/github/document-intelligence-engine/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/david/Desktop/github/document-intelligence-engine/.codex/notes/` — works in any directory
