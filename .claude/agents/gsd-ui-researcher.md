...
Use template from `C:/Users/david/Desktop/github/document-intelligence-engine/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Users/david/Desktop/github/document-intelligence-engine/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/Users/david/Desktop/github/document-intelligence-engine/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
